...
namespace ESPMath {
    ...
    /**
     * @brief Projects a 3D world coordinate to 2D screen coordinates without screen bounds checking.
     * @param worldPos The 3D world position to project.
     * @param camera The Camera object containing view and projection matrices.
     * @param screenWidth The width of the screen/viewport.
     * @param screenHeight The height of the screen/viewport.
     * @param outScreenPos Output parameter for the calculated 2D screen position (may be outside screen bounds).
     * @return True if the projected point is in front of the camera (w > 0), false otherwise.
     */
