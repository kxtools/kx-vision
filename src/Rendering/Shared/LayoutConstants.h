...
namespace RenderingLayout {
    ...
    constexpr float BURST_DPS_MIN_SPACING_FROM_BAR = 10.0f; // Minimum spacing from health bar when HP percentage is disabled
    constexpr float BURST_DPS_SPACING_FROM_HP_PERCENT = 8.0f; // Spacing between HP percentage text and burst DPS text
